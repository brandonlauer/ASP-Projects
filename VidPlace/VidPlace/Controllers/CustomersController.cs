...
namespace VidPlace.Controllers
{
    public class CustomersController : Controller
    {
        ...
        public ActionResult Index(string SearchString, string sort)
        {
            ...
            {
                // customers = (from c in customers where c.Name.Contains(SearchString) select c); -> LINQ expression
                customers = customers.Where(m => m.Name.Contains(SearchString)); // Lambda expression
        ...
        [HttpPost] // this method gets called after post back: when the delete button is clicked.
        public ActionResult Delete(int id)
        {
